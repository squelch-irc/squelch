...
const Server = (state, id, send) => {
  ...
  return html`
    <div>
      ...
      <h2 class="f7 fw4 ttu tracked o-40 mt0 mb1">Channels</h2>
      <h2 class="f7 fw4 ttu tracked o-40 mt0 mb1">Private Messages</h2>
    </div>
  `
}
...
module.exports = (state, prev, send) => {
  return html`
    <nav class="h-100 w-sidebar near-white bg-dark-gray ph3">
